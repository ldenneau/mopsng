...
Comments::CommentObj - Perl object used to represent individual comments added 
                       to a web page.

=head1 SYNOPSIS

  use Comments::CommentObj;
...
package Comments::CommentObj;

use Comments::Comment qw(:all);
...
<div class="comment">
    ...
    <div class="date" title="Added at $full_date">$short_date</div>
    <p>$self->{BODY}</p>
</div>
HTML
}
...
sub save {
    ...
    Comments::Comment::save_comment($self->{PAGE_ID}, $self->{NAME}, $self->{BODY});
}
