...
These tables live in the EXPORT database, a global DB for all MOPS processing.

create database export;
grant select, insert, update, delete on export.* to 'mopspipe'@'%' identified by 'epip';
grant select, insert, update, delete on export.* to 'mopspipe'@'localhost' identified by 'epip';
grant select, insert on export.* to 'mops'@'%' identified by 'mops';
grant select, insert on export.* to 'mops'@'localhost' identified by 'mops';
flush privileges;
