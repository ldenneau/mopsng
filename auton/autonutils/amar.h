...
void fprintf_ints(FILE *s, char *msg1, int *ints, int size, 
			   char *msg2);
...
void fprintf_longs(FILE *s, char *msg1, long *longs, int size, 
			    char *msg2);
...
void fprintf_bools(FILE *s, char *msg1, bool *bools, int size, 
			    char *msg2);
...
void fprintf_realnums(FILE *s, char *msg1, double *doubles, int size, 
			       char *msg2);

void printf_realnums(char *msg1, double *doubles, int size, 
			      char *msg2);
...
void doubles_scalar_multiply(double *f, int size, double alpha, 
				      double *res_f);

void doubles_add(double *f1, double *f2, int size, double *res_f);

void doubles_subtract(double *f1, double *f2, int size, 
			       double *res_f);

double doubles_scaled_dsqd(double *f1, double *f2, double *scales, 
				    int size);

double doubles_antiscaled_dsqd(double *f1, double *f2, double *scales,
					int size);

void doubles_reciprocal(double *farr, int size, double *res_farr);

void doubles_scalar_add(double *farr1, double *farr2, int size, 
				 double alpha, double *res_farr);
...
void set_2d_realnums_constant(double **tdarr, int rows, int cols, 
				       double val);

void copy_2d_realnums(double **tdarr1, double **tdarr2, int rows, 
			       int cols);
